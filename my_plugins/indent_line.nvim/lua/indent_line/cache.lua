...
-- local function has_indents(bufnr)
-- 	ts_query = nrequire('nvim-treesitter.query')
-- 	ts_indent = nrequire('nvim-treesitter.indent')
-- 	-- if not ts_indent then return end

-- 	if ts_indent and ts_query then --
-- 		ts_query.has_indents(vim.bo[bufnr].filetype)
-- 	end
-- end
